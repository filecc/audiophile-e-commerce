...
{
    return (
        <div className='flex flex-col items-center px-4 gap-8 py-6 lg:flex-row lg:justify-between lg:gap-0'>
        <div>
        ...
        <div className='text-center lg:text-start'>
           ...
           <div className='text-center lg:text-start opacity-40 font-medium leading-6 text-[15px] px-4 lg:px-0 lg:py-6'>
            <p>
