...
export default function SingleProduct({item})
{
    ...
    return (
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-5 px-4 my-10">
            <div className={"relative h-[350px] overflow-hidden rounded w-full lg:hidden"}>
            ...
            <div className={"relative lg:h-[560px] overflow-hidden rounded hidden lg:block lg:w-6/12 " + (item.id % 2 && 'order-2')}>
